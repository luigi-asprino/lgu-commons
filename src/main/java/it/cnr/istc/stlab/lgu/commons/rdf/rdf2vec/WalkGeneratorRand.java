...
public class WalkGeneratorRand {
	...
	public static List<String> selectAllEntities(int offset, int limit) {
		...
		String queryStrign = "Select distinct ?s Where { ?s <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> ?t } OFFSET "
				+ offset + "LIMIT " + limit;
	...
	public static void main(String[] args) {
		...
		generator.generateWalks("/Users/lgu/Desktop/fn17", "/Users/lgu/Desktop/fn17_walks", 200, 4, 1, 0, 100);
	}
}
